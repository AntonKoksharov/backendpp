...
async def ask_endpoint(request: Request):
    ...
    prompt = f"Используй предоставленный текст дял формирования ответа на вопрос пользователя. Если в данном тексте нет информации, то напиши, что ты не знаешь ответа, каждый ответ на вопрос пользователя начинай с фразы: 'Вот что удалось найти по вашему вопрос':\n{context}\n\nВопрос: {question}"
    try:
